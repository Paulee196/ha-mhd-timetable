...
const I18N = {
  cs: {
    title: "Timetables", loading: "Načítání…",
    no_stops: "Žádné zastávky nejsou nakonfigurovány.",
    no_stops_hint: "Přidejte zastávku v <strong>Nastavení → Integrace → Timetables</strong>.",
    ...
    help_card_auto: "Karta je připravena automaticky – na dashboardu zvolte <em>Upravit → Přidat kartu</em> a vyhledejte <strong>Timetables</strong>. Senzor zastávky se doplní sám. Toto je doporučený postup.",
  ...
  sk: {
    title: "Timetables", loading: "Načítavanie…",
    no_stops: "Nie sú nakonfigurované žiadne zastávky.",
    no_stops_hint: "Pridajte zastávku v <strong>Nastavenia → Integrácie → Timetables</strong>.",
    ...
    help_card_auto: "Karta je pripravená automaticky – na dashboarde zvoľte <em>Upraviť → Pridať kartu</em> a vyhľadajte <strong>Timetables</strong>. Senzor zastávky sa doplní sám. Toto je odporúčaný postup.",
  ...
  de: {
    title: "Timetables", loading: "Wird geladen…",
    no_stops: "Keine Haltestellen konfiguriert.",
    no_stops_hint: "Fügen Sie eine Haltestelle unter <strong>Einstellungen → Integrationen → Timetables</strong> hinzu.",
    help_tooltip: "Hilfe",
    ...
    help_card_auto: "Die Karte ist automatisch bereit – wählen Sie auf dem Dashboard <em>Bearbeiten → Karte hinzufügen</em> und suchen Sie nach <strong>Timetables</strong>. Der Haltestellen-Sensor wird automatisch ausgefüllt. Dies ist der empfohlene Weg.",
  ...
  fr: {
    title: "Timetables", loading: "Chargement…",
    no_stops: "Aucun arrêt configuré.",
    no_stops_hint: "Ajoutez un arrêt dans <strong>Paramètres → Intégrations → Timetables</strong>.",
    help_tooltip: "Aide",
    ...
    help_card_auto: "La carte est prête automatiquement – sur votre tableau de bord, choisissez <em>Modifier → Ajouter une carte</em> et recherchez <strong>Timetables</strong>. Le capteur de l'arrêt est rempli automatiquement. C'est la méthode recommandée.",
  ...
  es: {
    title: "Timetables", loading: "Cargando…",
    no_stops: "No hay paradas configuradas.",
    no_stops_hint: "Añada una parada en <strong>Ajustes → Integraciones → Timetables</strong>.",
    help_tooltip: "Ayuda",
    ...
    help_card_auto: "La tarjeta está lista automáticamente – en su panel elija <em>Editar → Añadir tarjeta</em> y busque <strong>Timetables</strong>. El sensor de la parada se rellena solo. Esta es la forma recomendada.",
